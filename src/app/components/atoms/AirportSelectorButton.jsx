...
export default function AirportSelectorButton({
  ...
  if (!isSelected) {
    return (
      <div
        className={`flex w-67 items-center gap-2 rounded-xl ring-2 ring-dark-300 px-2 py-3 text-dark-600 transition-colors duration-300 ease-in-out group-hover:ring-dark-400 hover:bg-dark-200 ${className}`}
      >
  ...
  return (
    <div className="flex w-full items-center gap-2">
      <div
        className={`flex w-69 min-w-0 items-center gap-2 rounded-xl ring-2 ring-dark-300 px-2 py-3 text-dark-0 ${className}`}
      >
        {Icon ? <Icon aria-hidden="true" className={iconClassName} /> : null}
