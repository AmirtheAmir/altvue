...
export default function InstructionsPanel({ onBack }) {
  return (
    <section className="fixed left-1/2 top-1/2 z-40 flex h-120 w-108 max-w-[calc(100vw-2rem)] -translate-x-1/2 -translate-y-1/2 flex-col gap-6 overflow-y-auto rounded-3xl bg-dark-248 p-3 text-dark-0 shadow-[0_0_72px_rgba(0,0,0,0.72)] backdrop-blur-lg">
